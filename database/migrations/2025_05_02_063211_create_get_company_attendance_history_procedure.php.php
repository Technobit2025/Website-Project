...
class CreateGetCompanyAttendanceHistoryProcedure extends Migration
{
    public function up()
    {
        // Hapus prosedur jika sudah ada
        DB::statement('DROP PROCEDURE IF EXISTS get_company_attendance_history_by_employee');
