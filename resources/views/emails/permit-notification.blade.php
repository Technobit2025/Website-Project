...
<head>
    ...
    <title>Permohonan Izin | {{ env('APP_NAME') }}</title>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px">
                                    <h6 style="font-weight: 600; margin-bottom: 18px;">Pengajuan Perizinan
                                    </h6>
                                    ...
                                    <table class="detail-table">
                                        ...
                                        @if ($permit->employee_is_confirmed)
                                            <tr>
                                                <td class="label">Status Konfirmasi Dari Anda</td>
                                                <td class="value">
                                    ...
                                    @if ($permit->alternate)
                                        <div style="margin-top: 24px;">
                                            ...
                                            <table class="detail-table" style="margin-bottom: 0;">
                                                <tr>
                                                    <td class="label">Nama Pengganti</td>
                                                    <td class="value">: {{ $permit->alternate->fullname }}</td>
                                                </tr>
                                                @if ($permit->alternate->user->email ?? false)
                                                    <tr>
                                                        <td class="label">Email Pengganti</td>
                                                        <td class="value">: {{ $permit->alternate->user->email }}</td>
                                                    </tr>
                                                @endif
                                                @if ($permit->alternateCompanySchedule)
                                                    <tr>
                                                        <td class="label">Jadwal Pengganti</td>
                                                        <td class="value">
                                                ...
                                                @if ($permit->alternate_is_confirmed)
                                                    <tr>
                                                        <td class="label">Status Konfirmasi Dari Pengganti</td>
                                                        <td class="value">
                                    ...
                                    <div style="text-align: center;">
                                        <a class="btn" href="{{ url('/permit/show/' . $permit->id) }}">Lihat Detail
                                            &amp; Setujui Izin</a>
                                    </div>
