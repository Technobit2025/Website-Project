...
class EnvController extends Controller
{
    public function index()
    {
        ...
        foreach ($envLines as $line) {
            ...
            $blackList = ['HASHED_MASTER_PASSWORD'];
        ...
        return view('super_admin.env.index', compact('envData'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $hashedPassword = env('HASHED_MASTER_PASSWORD');
        ...
        // Pastikan HASHED_MASTER_PASSWORD tetap ada
        if (!in_array('HASHED_MASTER_PASSWORD="' . $hashedPassword . '"', $newEnvLines)) {
            $newEnvLines[] = 'HASHED_MASTER_PASSWORD="' . $hashedPassword . '"';
        }
